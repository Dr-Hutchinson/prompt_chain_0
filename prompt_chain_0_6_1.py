...
with col1:
    ...
    pdf_display = F'<iframe src="https://thomasmorestudies.org/wp-content/uploads/2020/09/Richard.pdf;base64,{base64_pdf}" width="700" height="1000" type="application/pdf"></iframe>'
